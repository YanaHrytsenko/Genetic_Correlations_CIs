...
Rscript 5_compute_CI_from_parametric_bootstrap_PMF.R $simulation_database_path $simulation_data_useful_format $bin_size $alpha $cover_prob_all_path_pmf $CI_width_all_path_pmf $cover_prob_settingA_pmf_path $CI_width_settingA_pmf_path
